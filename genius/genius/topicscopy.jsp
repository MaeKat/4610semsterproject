...
<html lang="en">
  ...
  <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
          <div class="container">
              <a class="navbar-brand" href="index.html" style="width:100px; height:100px;">
                  <img src="images/lspaclogo.jpg" alt=""height = "100px" width="250px">
                </a>
              <!-- <div class="one-forth order-first img" style="background-image: url(images/lspaclogo.jpg);"></div> -->
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a href="topics.html" class="nav-link">Topics</a></li>
                <li class="nav-item"><a href="teacher.html" class="nav-link">Mentors</a></li>
                <li class="nav-item"><a href="blog.html" class="nav-link">Forms</a></li>
                <li class="nav-item"><a href="event.html" class="nav-link">Events</a></li>
                <li class="nav-item"><a href="contact.html" class="nav-link">Login</a></li>
                <li class="nav-item cta"><a href="signup.html" class="nav-link"><span>Signup!</span></a></li>
              </ul>
            </div>
          </div>
        </nav>
              ...
              <div class="courseSearch-wrap d-md-flex flex-column-reverse">
                <div class="full-wrap d-flex ftco-animate">
                  <div class="one-third order-last p-5">
                    <!-- <span>What's your passion?</span> -->
                    <!-- <h3>I want to research...</h3> -->
    			...
    			<div class="col-md-4 d-flex ftco-animate">
    				<div class="course align-self-stretch">
    					<div class="text p-4">
    						...
    						<h3 class="mb-3"><a href="#">Shakespeare</a></h3>
                <p><a href="#" class="btn btn-primary">Add intrest</a>
                  <a href="#" class="btn btn-primary">View the Forms</a>
                </p>
    					</div>
    				</div>
    			</div>
        ...
        <div class="row mb-5">
          <div class="col-md-3">
            <div class="ftco-footer-widget mb-4">
                <h2 class="ftco-heading-2">Louis Stokes Center for Promotion of Academic Careers</h2>
              <h2><a class="navbar-brand" href="index.html" style="width:100px; height:100px;"><img src="images/lspaclogo.jpg" alt=""height = "100px" width="250px"></img></a></h2>
                <a href="https://twitter.com/lspacmodels?lang=en"><span class="icon-twitter"></span></a>
          ...
          <div class="col-md-2">
             <div class="ftco-footer-widget mb-4 ml-md-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="#" class="py-2 d-block">Topics</a></li>
          ...
          <div class="col-md-3">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
                  <li><span class="icon icon-person"></span><span class="text">Timothy E. Johnson, PhD</span></li>
                  <li><span class="icon icon-map-marker"></span><span class="text">213 Hatcher Hall<p></p>Louisiana State University </span></li>
                  <li><span class="icon icon-phone"></span><span class="text">+2 235 578 72222</span></li>
	                <li><span class="icon icon-envelope"></span><span class="text">tjohnson9@lsu.edu</span></li>
	              </ul>
	            </div>
            </div>
          </div>
